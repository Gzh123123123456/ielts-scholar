...
import { BookOpen, Mic, PenTool, History, LayoutDashboard } from 'lucide-react';
...
export const TopBar: React.FC = () => {
  ...
  return (
    <nav className="top-bar-shell flex items-center justify-between mb-12 border-b border-paper-ink/10 pb-4 notranslate" translate="no">
