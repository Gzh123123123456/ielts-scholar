# Agent Workflow 鈥?IELTS Scholar

## Project Identity

Project: IELTS Scholar 鈥?Local-First Training Agent  
...
Committing is allowed after a completed slice if the user鈥檚 current workflow allows it.
